...
Craft beautiful, minimalistic finite automata visuals with a fluent Python API and a purpose-built rendering engine.
...
Add PNG support by installing the optional Cairo extra:
